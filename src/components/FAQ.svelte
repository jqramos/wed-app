            ...
            <div class="col-span-full lg:col-span-7 flex items-center">
                <div class="px-s2 lg:px-s5 py-s8 bg-grey-rgba-700">
                    <h2 class="mb-s4 lg:mb-s max-w-[570px]">
                        <span class="font-serif text-h3 lg:text-h2 uppercase">Frequently</span> 
                        <span class="block font-sans text-p2 lg:text-h3 text-right text-primary-300 font-light italic -translate-y-[20px] lg:-translate-y-[30px]">asked questions</span>
                    </h2>
                    <div class="min-h-[250px]">
                        <div class="carousel-text js-carousel-detail" data-active-slide="true">
                            <h3 class="text-p1 lg:text-p2 mb-s1 text-primary-300">What time should I arrive?</h3>
                        ...
                        <div class="carousel-text js-carousel-detail" data-active-slide="false">
                            <h3 class="text-p1 lg:text-p2 mb-s1 text-primary-300">Can we take pictures and videos during the wedding ceremony?</h3>
                        ...
                        <div class="carousel-text js-carousel-detail" data-active-slide="false">
                            <h3 class="text-p1 lg:text-p2 mb-s1 text-primary-300">Can I bring someone with me? (Plus one, date, driver, etc.)</h3>
